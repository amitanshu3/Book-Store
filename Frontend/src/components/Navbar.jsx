...
const Navbar = () => {
  ...
  useEffect(()=>{
   ...
   return ()=>{
    window.removeEventListener('scroll',handaleScroll);
   }
  ...
  return (
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4   top-0 left-0 right-0 z-50 fixed  dark:bg-slate-900 dark:text-white ${sticky?"sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out":""}`}>
